...
from formula_screening.db.repository import upsert_financial_item, upsert_stock
...
def test_build_stock_dict(conn):
    ...
    upsert_financial_item(conn, "7203", "2024-03", "pl", "basic_eps", 359.56, "edinetdb")
    upsert_financial_item(conn, "7203", "2024-03", "bs", "total_equity", 36878914, "edinetdb")
    conn.commit()

    mock_price = {"price": 2500.0, "shares_outstanding": 13048929774}
    with patch("formula_screening.screener.fetch_current", return_value=mock_price):
